...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFF2C94C);
  late Color tertiary = const Color(0xFFF2994A);
  late Color alternate = const Color(0xFF6FCF97);
  ...
  late Color accent1 = const Color(0xFF56CCF2);
  late Color accent2 = const Color(0xFFEB5757);
  late Color accent3 = const Color(0xFFBB6BD9);
  late Color accent4 = const Color(0xFFFFA15A);
  late Color success = const Color(0xFF27AE60);
  late Color warning = const Color(0xFFF2994A);
  late Color error = const Color(0xFFEB5757);
  late Color info = const Color(0xFF56CCF2);
}
